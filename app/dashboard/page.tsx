...
export async function GET(req: NextRequest) {
  try {
    ...
    const topLanguage = Object.entries(langCount).sort((a, b) => b[1] - a[1])[0]?.[0] ?? 'hi-IN'
    ...
    return NextResponse.json({ totalSessions, activeSessions, resolvedToday, avgMessagesPerSession: avgMessages, topLanguage, departmentBreakdown, sentimentBreakdown, recentSessions })
  } catch (err) {
